    ...
    def pacificAtlantic(self, matrix):
        ...
        def _dfs(i, j, visited):
            ...
            for x, y in directions:
                ...
                if 0 <= next_i < m and 0 <= next_j < n and not visited[next_i][next_j] and matrix[next_i][next_j] >= matrix[i][j]:
                    _dfs(next_i, next_j, visited)

        reaches_atlantic_and_pacific = []
        if not matrix or len(matrix) == 0 or len(matrix[0]) == 0:
            return reaches_atlantic_and_pacific
